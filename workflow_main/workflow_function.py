...
def generateImage(image_bytes: bytes, animal_type: str, first_name: str, last_name: str, animal_name: str) -> io.BytesIO:
    ...
    with torch.inference_mode():
        ...
        # Now use 'prompt' in your analyze_image call
        ...
        loadimage_60 = loadimage.load_image(image=load_animal_image(base_path, animal_type, "front"))
        loadimage_64 = loadimage.load_image(image=load_animal_image(base_path, animal_type, "back"))
        loadimage_71 = loadimage.load_image(image=load_animal_image(base_path, animal_type, "side"))
        loadimage_72 = loadimage.load_image(image=load_animal_image(base_path, animal_type, "front2"))

        loadimage_111 = loadimage.load_image(image="/mnt/data/tbkh2025_dk/ComfyUI/input/pasted/image.png")
