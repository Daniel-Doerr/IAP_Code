...
# Test animal data
TEST_ANIMALS = [
    {"first_name": "Max", "last_name": "Mustermann", "animal_name": "Teddy", "animal_type": "cat"},
    {"first_name": "Anna", "last_name": "Schmidt", "animal_name": "Fluffy", "animal_type": "dog"},
    {"first_name": "Tom", "last_name": "Johnson", "animal_name": "Buddy", "animal_type": "cat"},
    {"first_name": "Lisa", "last_name": "Weber", "animal_name": "Luna", "animal_type": "dog"},
]
...
async def get_job(user=Depends(verify_token)):
    ...
    # Simulate no job available sometimes (but less frequently) - DISABLED FOR TESTING
    # if job_counter % 20 == 19:  # Every 20th request returns no job
    #     print(f"Simulating no job available for request {job_counter}")
    #     job_counter += 1  # Increment counter even when no job is returned
    #     return Response(status_code=204)  # No Content
